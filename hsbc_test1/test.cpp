...
namespace hsbctest
{
    ...
    TEST(ProbabilisticRandomGenTest, TestNextFromSampleNormalUsage)
    {
        RandomizerProxy tr;
    ...
    TEST(ProbabilisticRandomGenTest, TestDistributionUniform)
    {
    ...
    TEST(ProbabilisticRandomGenTest, TestDistribution)
    {
    ...
    TEST(ProbabilisticRandomGenTest, TestNextFromSampleWithFixedRandomizer)
    {
    ...
    TEST(ProbabilisticRandomGenTest, TestNextFromSampleWithFiveRandomValues) 
    {
