...
namespace bus_simple
{
	...
	TEST(bus_simple, SubscriberHistoriseTest)
	{
	...
	TEST(bus_simple, TestAddSubscriber)
	{
	...
	TEST(bus_simple, TestAddSubscriberForFilteredEvents)
	{
		//no subscriber
		SubscribersMap subscribersMap;
		EventBus EventBus(subscribersMap);
	...
	TEST(bus_simple, TestAddSubscriberForFilteredEventsReplaceSubscriber)
	{
		//no subscriber
		SubscribersMap subscribersMap;
		EventBus EventBus(subscribersMap);
