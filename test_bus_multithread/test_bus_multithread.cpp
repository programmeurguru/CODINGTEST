...
namespace bus_multithread 
{
	...
	TEST(bus_multithread, TestAllinOne)
	{
	...
	TEST(bus_multithread, EventQueueSingleTest)
	{
		std::vector<std::thread> consumers;
		EventQueue evQueue;
		SharedSubscribersPredicateMap subscribersPredicateMap;
	...
	TEST(bus_multithread, EventQueuethreeTest)
	{
		std::vector<std::thread> consumers;
		EventQueue evQueue;
		SharedSubscribersPredicateMap subscribersPredicateMap;
	...
	TEST(bus_multithread, EventQueueOveridesubscriptionTest)
	{
