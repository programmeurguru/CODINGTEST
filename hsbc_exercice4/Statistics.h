...
namespace hsbctest4
{
	...
	public:
		...
		void AddAndcalculate(int value);

		int get(int pctile) const;
	};
	...
	public:
		Statistics(double mean, int mode, int pctile, int pctilet) :
		...
		void setPctile(int i) { _pctile = i; };// it is the value at a percetage threshold

		double getMean() const { return _mean; }
		int getMode() const { return _mode; };
		int getPctile() const { return _pctile; }// it is the value at a percetage threshold
